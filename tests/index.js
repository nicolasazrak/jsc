...
describe('JSC', () => {
  describe('resolveFileName()', () => {
    ...
    it('should work on a relative import inside a node module', () => {
      expect(resolveFileName('./node_modules/lodash/isNumber.js', './somedep')).to.eql('./node_modules/lodash/somedep.js');
    ...
    it('should work on main package of a node module', () => {
      expect(resolveFileName('./src/a.js', 'lodash')).to.eql('./node_modules/lodash/lodash.js');
